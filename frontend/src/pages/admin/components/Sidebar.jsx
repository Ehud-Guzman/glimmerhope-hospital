export default function Sidebar({ active, setActive }) {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-gray-50 to-white shadow-sm border-r border-gray-100 p-5 h-screen sticky top-0">
      ...
      <ul className="space-y-1">
        {links.map(link => (
          <li key={link.id}>
            ...
            >
              <span className={`${active === link.id ? "text-blue-500" : "text-gray-400"}`}>
                {link.icon}
              </span>
      ...
      <div className="absolute bottom-5 left-5 right-5 p-3 bg-gray-50 rounded-xl border border-gray-100">
